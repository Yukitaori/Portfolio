...
export default function MenuBurger({showMenu, setShowMenu}) {
  const [checkbox, setCheckBox] = useState(<input id={styles.toggle} type="checkbox"></input>)
  const handleClick = () => {
    showMenu ? setShowMenu(false) : setShowMenu(true);
  }
  useEffect(() => {
    showMenu ? setCheckBox (<input id={styles.toggle} type="checkbox" checked></input>) : setCheckBox(<input id={styles.toggle} type="checkbox"></input>)
  }, [showMenu])
  return (
